    ...
    public class InMemoryYearBookService : IYearBookService
    {
        ...
        public InMemoryYearBookService()
        {
            _yearBookEntries = new List<YearBookEntry>
            {
                ...
                new YearBookEntry(4, "Harry4", "he", "Speaks 4 languages", "https://img.freepik.com/free-photo/man-glasses-orange-shirt-surprised-confused-standing-green-wall_141793-61019.jpg?size=626&ext=jpg", 2018),
